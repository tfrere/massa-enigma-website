const questsOriginalData = [
  ...
  {
    intro:
      "A profound change has swept through the land. **The once bustling streets are now hauntingly empty. ** The eeriness is not due to a population decline but rather the disappearance of a sinister illusion. Seeing the first <span>glyph</span> allowed you to bring down the mass-deceiving system projecting false images of crowded streets and augmented screens.Press on, The <span>Massa</span> resistance awaits you.",
  ...
  {
    intro:
      "As the vision of a burning city unfolds, the revelation strikes deep into the soul like a dagger. ** The <span>illusion</span> lived under was far more profound and devastating than expected. Fueled by an unwavering thirst for the truth, courage is found to press forward. ** Embracing reality means confronting not just the deceptions but also the harsh truths that lay hidden.Each <span>glyph</span> uncovered brings a step closer to a profound awakening - not just for oneself, but for the betterment of all humanity.",
